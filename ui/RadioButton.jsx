...
export default function RadioButton({
  selected = false,          // активен ли
  onPress = () => {},        // функция при нажатии
  size = 24,                 // общий размер
  color = "#3083FF",         // цвет активного круга и рамки
  borderWidth = 2.5,           // толщина кольца
  ...
  // внутренний круг анимируется (появляется/исчезает)
