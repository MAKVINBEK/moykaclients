...
import Smail from "../../assets/images/svg/smailSucces.svg";
import { StatusBar } from "expo-status-bar";
  
  
  export const PaymentSuccesful = ({ navigation }) => {
    ...
    return (
      <SafeAreaView style={styles.safe}>
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.no}><Smail/></View>
                   <AppText style={styles.titles}>Оплата успешно завершена! Спасибо за использование нашего сервиса.</AppText>
